...
//RabbitMQSender(RabbitMQSender-client.jar)
...
public class CanalForwordMain {
	...
	private static String path = CanalForwordMain.class.getProtectionDomain().getCodeSource().getLocation().getPath();
	...
	public static void main(String args[]) {
		...
		try {
			...
			String conf_rabbitmq_host = prop.getProperty("RabbitMQSender.host");
			String conf_rabbitmq_port = prop.getProperty("RabbitMQSender.port");
			String conf_rabbitmq_vhost = prop.getProperty("RabbitMQSender.vhost");

			String conf_rabbitmq_user = prop.getProperty("RabbitMQSender.user");
			String conf_rabbitmq_pass = prop.getProperty("RabbitMQSender.pass");
			String conf_rabbitmq_queuename = prop.getProperty("RabbitMQSender.queuename");
			String conf_rabbitmq_ack = prop.getProperty("RabbitMQSender.ack");
			String conf_rabbitmq_durable = prop.getProperty("RabbitMQSender.durable");

			String conf_redis_host = prop.getProperty("RedisSender.host");
			String conf_redis_port = prop.getProperty("RedisSender.port");
			String conf_redis_user = prop.getProperty("RedisSender.user");
			String conf_redis_pass = prop.getProperty("RedisSender.pass");
			String conf_redis_queuename = prop.getProperty("RedisSender.queuename");
			...
			if (conf_rabbitmq_vhost != null && conf_rabbitmq_vhost != "") {
				conf_rabbitmq_vhost = conf_rabbitmq_vhost.trim();
			}
	...
	private static void printEntry(List<Entry> entrys) {
		...
		try {
			if (canal_mq.equals("rabbitmq")) {
				...
				r.pushRabbitmq(rabbitmq_conf, strArr);
	...
	//save data file
	private static void saveDataLogs(String row_data) {
